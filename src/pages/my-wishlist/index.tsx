...
import { BrokenHeartIcon, FilterIcon } from "components/SvgIcons";
import { RECOMMENDED_FOR_YOU } from "../../demodata";
import ProductItem from "components/ProductItem";
import CheckBox from "components/CustomCheckboxInput";
import { Button } from "components/Button";

const MyWishlist: NextPage = () => {
  const [wishlist, setWishlist] = useState(RECOMMENDED_FOR_YOU.slice(10, 15));
  ...
  return (
    <Layout
      showSideBar
      sideBarTitle="My Wishlist"
      sideBarBreadcrumb="My Wishlist"
    >
      {wishlist.length > 0 ? (
        <>
          <div className="grid grid-cols-2">
            <div className="text-[17px] font-bold mt-4 mb-5">
              Showing {wishlist.length} items{" "}
              <span
        ...
        <div className="grid grid-cols-12">
          <div className="col-start-4 col-span-6">
            ...
            <div className="text-center p-14 text-[16px] text-apollo-light-gray">
              You don&rsquo;t have any items on your wishlist. If you want, you
              can browse and add the items you like to your wishlist.
            </div>
